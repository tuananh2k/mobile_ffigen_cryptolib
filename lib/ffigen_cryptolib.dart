...
import 'ffigen_cryptolib_bindings_generated.dart';
...
// Converts a Dart [String] to a null-terminated Utf8 C string.
Pointer<Utf8> toCString(String s) {
  return s.toNativeUtf8().cast<Utf8>();
}

// Converts a null-terminated Utf8 C string to a Dart [String].
String fromCString(Pointer<Utf8> s) {
...
const String _libName = 'ffigen_cryptolib';

/// The dynamic library in which the symbols for [FfigenCryptolibBindings] can be found.
...
final FfigenCryptolibBindings _bindings = FfigenCryptolibBindings(_dylib);
